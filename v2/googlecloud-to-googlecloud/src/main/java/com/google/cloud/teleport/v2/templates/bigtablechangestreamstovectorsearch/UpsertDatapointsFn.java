...
public class UpsertDatapointsFn extends DatapointOperationFn<Iterable<IndexDatapoint>> {
  ...
  private ArrayList<IndexDatapoint> datapoints = new ArrayList<>();
  ...
  public void processElement(@Element Iterable<IndexDatapoint> datapoints) {
    LOG.debug("Enqueuing datapoint for upsert: {}", datapoints);
  ...
  public void finishBundle() {
    ...
    LOG.debug("Upserting {} datapoints", datapoints.size());
